...
public class ResultPreparator {
    ...
    private void setSelectStart(String select){
        this.xmlData.append("<sqlSelect><selectCode>" + symbolsToXMLFormat(select) + "</selectCode>");
    }
    ...
    public void prepareData(String select, ParseTree tree, Parser parser){
        setSelectStart(select);
